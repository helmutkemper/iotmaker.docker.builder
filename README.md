...
### func \(\*ContainerBuilder\) [SetGitCloneToBuildWithUserPassworh](<https://github.com/helmutkemper/iotmaker.docker.builder/blob/main/funcSetGitCloneToBuildWithUserPassworh.go#L108>)
