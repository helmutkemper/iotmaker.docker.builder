...
// A valid value might be 0-3 (to use the first, second, third, and fourth CPU) or 1,3 (to use the second and
// fourth CPU).
//
// Português: Limite a quantidade de CPUs ou núcleos específicos que um container pode usar.
// Uma lista separada por vírgulas ou intervalo separado por hífen de CPUs que um container pode usar, se você
// tiver mais de uma CPU.
// A primeira CPU é numerada como 0.
// Um valor válido pode ser 0-3 (para usar a primeira, segunda, terceira e quarta CPU) ou 1,3 (para usar a segunda
// e a quarta CPU).
