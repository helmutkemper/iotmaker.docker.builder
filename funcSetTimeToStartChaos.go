...
// SetTimeToStartChaos
//
// English: This function sets a timeout before the chaos test starts, when indicator text is encountered in the standard output.
//   Input:
...
//
//   Note: - This function is used in conjunction with the AddStartChaosMatchFlag(), AddStartChaosMatchFlagToFileLog() or AddFilterToStartChaos() functions
//
// Português: Esta função define um tempo de espera antes do teste de caos começar, quando o texto indicador é incontrado na saída padrão.
//   Entrada:
...
//
//   Nota: - Esta função é usada em conjunto com as funções AddStartChaosMatchFlag(), AddStartChaosMatchFlagToFileLog() ou AddFilterToStartChaos()
