...
// AddSuccessMatchFlag
//
// English: Adds a text to be searched for in the container's standard output, indicating test success
//   Input:
//     value: Text searched for in the container's standard output
//
// Português: Adiciona um texto a ser procurado na saída padrão do conteiner, indicando sucesso do teste
//   Entrada:
