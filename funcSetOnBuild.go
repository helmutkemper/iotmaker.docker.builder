...
// SetOnBuild (english): Adds to the image a trigger instruction to be executed at a later
...
//
// SetOnBuild (português): Adiciona à imagem uma instrução de gatilho a ser executada
// posteriormente, quando a imagem for usada como base para outra construção.
//
